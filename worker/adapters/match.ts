// Shared helpers for the score adapters: team-name normalization and fuzzy
// fixture matching. Adapters produce `MatchResult`s from different sources;
// these functions are source-agnostic and let the worker line a bet's event
// text up with the right game.
